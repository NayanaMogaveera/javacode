...
public class Display_Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Perticualr Record");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student_no", "Student Name", "Date of Birth", "DAte of Join"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
             Connection con= DriverManager.getConnection("jdbc:mysql://localhost/interview","root","");
             Statement st=con.createStatement();
            String sql="select * from student";
            ResultSet rs=st.executeQuery(sql);
            while(rs.next())
            {
                String id=String.valueOf(rs.getInt("student_no"));
                String name=rs.getString("name");
                String dob=rs.getString("dob");
                String doj=rs.getString("doj");
                
                String tbData[]={id,name,dob,doj};
